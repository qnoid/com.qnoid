...
import com.qnoid.java.tgOg.FizzBuzzOperation;
import com.qnoid.java.tgOg.ModFizzBuzz;
 ...
 * @date Feb 23, 2011
 */
public class FizzBuzzStrategies
{

    /**
     * Uses an array of {@link FizzBuzzOperation}s to find the one that applies
     */
    public static final FizzBuzzStrategy DEFAULT = new FizzBuzzStrategy() 
    {
        ...
        /**
         * @return the first one that applies
         */
        @Override
