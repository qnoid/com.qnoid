...
public class ConditionNotSatisfiedException extends RuntimeException 
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7349909101440772294L;
	 ...
	 * @param condition
	 */
	public ConditionNotSatisfiedException(Condition<?> condition) 
	{
	...
	return String.format("Condition: %s", this.condition)
